...
<div class="mb-8">
    ...
    <p class="text-gray-600 text-lg mt-2">Verifikasi bukti pembayaran wisuda dari mahasiswa</p>
</div>
...
<div class="auth-card text-center py-12">
    ...
    <p class="text-gray-600 text-sm">Semua pembayaran wisuda sudah diverifikasi.</p>
</div>
@endif
@endsection
