    ...
    <div class="w-full">
        <div class="grid grid-cols-1 lg:grid-cols-5 w-full min-h-screen bg-white overflow-hidden">
            ...
            <div class="lg:col-span-2 p-10 flex flex-col justify-center text-white relative overflow-hidden">
                <div class="w-full h-full bg-linear-to-b from-[#056100] to-[#00DF1A] rounded-[40px] p-10 relative overflow-hidden">
            ...
            <div class="lg:col-span-3 p-10 overflow-y-auto max-h-screen relative">
                ...
                <div class="relative z-10 max-w-md mx-auto">
                    <div class="text-center mb-8">
                        ...
                        <h1 class="text-5xl font-bold mb-3 bg-linear-to-r from-[#056100] to-[#00DF1A] bg-clip-text text-transparent">
                            Masuk akun anda
                        </h1>
                    ...
                    <form method="POST" action="{{ route('admin.login') }}" class="space-y-6">
                        ...
                        <button type="submit"
                                class="w-full bg-linear-to-r from-[#056100] to-[#00DF1A] text-white py-3 px-4 rounded-xl
