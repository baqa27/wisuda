    ...
    <div class="w-full">
        <div class="grid grid-cols-1 lg:grid-cols-5 w-full min-h-screen bg-white overflow-hidden">
            ...
            <div class="lg:col-span-2 p-10 flex flex-col justify-center text-white relative overflow-hidden">
                <div
                    class="w-full h-full bg-linear-to-b from-[#0A0061] to-[#0061DF] rounded-[40px] p-10 relative overflow-hidden">
            ...
            <div class="lg:col-span-3 p-10 overflow-y-auto max-h-screen relative">
                ...
                <div class="relative z-10 max-w-md mx-auto">
                    <div class="text-center mb-8">
                        ...
                        <h1
                            class="text-5xl font-bold mb-3 bg-linear-to-r from-[#0A0061] to-[#0061DF] bg-clip-text text-transparent">
                            Masuk akun anda
                        </h1>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <!-- Email / NIM -->
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Email / NIM</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <i class="fas fa-user text-gray-400"></i>
                                </div>
                                <input type="text" id="identity" name="identity" value="{{ old('identity') }}" required class="w-full pl-11 pr-4 py-3 border-2 border-gray-200 rounded-xl
                                           focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all"
                                    placeholder="Masukan Email atau NIM anda">
                            </div>
                        </div>
                        ...
                        <button type="submit" class="w-full bg-linear-to-r from-[#0A0061] to-[#0061DF] text-white py-3 px-4 rounded-xl
